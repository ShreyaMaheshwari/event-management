...
<body> 
	<div id="header" align="right">
		...
		<a href="myacc.php" class="header_links" style="color: #e15b00; border-bottom: 2px solid #e15b00;">My Account</a>
		<a href="book_stu.php" class="header_links">Book an event</a>
		<a href="home_stu.html" class="header_links">About</a>
	...
	<?php
        ...
        $id=$_SESSION['sid'];
        $sql = "SELECT sname,sphone,semail,sstream,spassword,scollege,sid FROM student WHERE sid='$id';";
      ...
      echo '<label>';
      echo '<span style="font-size:15px">stream</span>';
      echo '<input type="text" name="stream" value="'.$row[3].'" disabled><br>';
      echo '</label>';

      echo '<label>';
      echo '<span style="font-size:15px">password</span>';
      echo '<input type="password" name="password" value="'.$row[4].'" disabled><br>';
      echo '</label>';

      echo '<label>';
      echo '<span style="font-size:15px">college</span>';
      echo '<input type="text" name="college" value="'.$row[5].'" disabled><br>';
      echo '</label>';
